const credentials = [
  ...
  { title: 'AI vs. Cybercrime: Human Firewall', category: 'security', label: 'Security', icon: '04', file: 'Abdul Qadeer  Certificate.pdf' },
  { title: 'AI Automation Assistant Engineer', category: 'security', label: 'Security', icon: '05', file: 'Abdul_Qadeer AI Automation Assistant Engineer Certificate.pdf' },
